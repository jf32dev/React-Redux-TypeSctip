...
const Summary = ({ setValue, values }: TSummary) => {
  ...
  /**
   * Selected Product will determine the unitsPerCase, costPerCase, and tax of each product
   */
